...
const LoginPage = (props) => {
    ...
    return (
        <div>
            {(token && token !== "" && token !== undefined) ? <><section class="py-5"/><h1 class="text-center">Welcome {currentUser}!</h1></> : 
                <div>
                    <section class="py-5"/>
                    <div class="container">
                    <div class="row gx-5">
                        ...
                        onChange = {(e) => setPassword(e.target.value)} placeholder="Password" /></div>
                                        <div class="mb-3"><button class="btn btn-primary shadow d-block w-100" onClick={handleSubmit}>Log in</button></div>
                                    </form>
                                </div>
                            </div>
