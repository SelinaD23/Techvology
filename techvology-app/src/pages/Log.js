...
const Log = () => {
    ...
    return (
        <div>
            <section class="py-3"/>
            <div>
                <div class="card-body text-center bg-dark border rounded border-dark d-flex flex-column align-items-center" style={{margin: '20px', paddingTop: '30px', paddingBottom: '20px'}}>
                <h2 class="fw-bold"><br /><strong>Add Custom Action</strong><br /><br /></h2>
                    <form>
                        <div class="mb-3">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6"><input class="form-control-sm" type="text" id="title" placeholder="Action Name" value={actionTitle} onChange={(e) => setActionTitle(e.target.value)}/></div>
                                    <div class="col-md-6"><input class="form-control-sm" type="number" id="carbon" placeholder="Carbon" value={actionCarbon} onChange={(e) => setActionCarbon(e.target.value)} /></div>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3"></div>
                        <div class="mb-3"><button class="btn btn-primary shadow d-block w-100" onClick={handleCustomAction}>Add Action</button></div>
                    </form>
                </div>
            </div>
